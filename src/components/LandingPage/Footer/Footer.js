    ...
    return (
      <div>
        {/* <div className="fixed-action-btn">
          ...
          <ul>
            <li><Link className="btn-floating red"><i className="material-icons">chat</i></Link></li>
            <li><Link className="btn-floating yellow darken-3"><i className="material-icons">bookmark</i></Link></li>
